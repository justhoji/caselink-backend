...
export class CreateAirportsAndAgencyProfileSchema1785845100000 implements MigrationInterface {
  name = 'CreateAirportsAndAgencyProfileSchema1785845100000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // 1. Update agency_page_sections_section_key_enum values
    ...
    // 2. Create airports table & indexes for sub-millisecond search performance
    await queryRunner.query(`
    ...
    // 3. Add social links & landing page settings columns to agencies table
    await queryRunner.query(
